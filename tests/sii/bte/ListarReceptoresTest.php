...
/**
 * Clase de pruebas para listar los receptores de las Boletas de Terceros
...
class ListarReceptoresTest extends TestCase
{
    ...
    /**
     * Método de test que prueba el recurso de listar receptores de las BTEs emitidas.
     *
    ...
    public function testListarReceptores()
    {
        try {
            ...
            if (self::$verbose) {
                echo "\n",'testListarReceptores() BTEs: ',$response->getBody()->getContents(),"\n";
            }
