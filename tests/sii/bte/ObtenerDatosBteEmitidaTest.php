...
/**
 * Clase de pruebas para obtener detalles de una Boleta de Terceros Electrónica emitida.
 */
class ObtenerDatosBteEmitidaTest extends TestCase
{
    use FunctionHelpers;
    /**
    ...
    /**
     * Método de test que prueba el recurso de obtener datos de una BTE emitida.
     *
