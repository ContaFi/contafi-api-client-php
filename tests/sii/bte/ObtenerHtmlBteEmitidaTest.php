...
/**
 * Clase de pruebas para descargar el HTML de una Boleta de Terceros Electrónica emitida.
 */
class ObtenerHtmlBteEmitidaTest extends TestCase
{
    ...
    /**
     * Método de test que prueba el recurso de descargar un archivo HTML de
     * una BTE emitida.
     *
     ...
     * @return void
     */
    public function testObtenerHtmlBteEmitida(): void
    {
        $filtros = [
        ...
        try {
            ...
            $response = self::$client->html(self::$testNumero);
            ...
            if (self::$verbose) {
                echo "\n",
                'testObtenerHtmlBteEmitida() Archivo: ',
                $filename,
                "\n";
            }
