...
/**
 * Clase de pruebas para listar proveedores de los documentos de ventas.
 */
class ListarProveedoresTest extends TestCase
{
    /**
    ...
    /**
     * Método de test que prueba el recurso de listar proveedores de los DTEs
    ...
    {
        try {
            $response = self::$client->listadoProveedores();

            $this->assertSame(200, $response->getStatusCode());

            if (self::$verbose) {
                echo "\n",'testListarProveedores() Proveedores: ',$response->getBody()->getContents(),"\n";
            }
