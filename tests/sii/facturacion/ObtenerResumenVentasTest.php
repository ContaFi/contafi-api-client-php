...
/**
 * Clase de pruebas para obtener un resumen de ventas sin detalle del contribuyente.
 */
class ObtenerResumenVentasTest extends TestCase
{
    /**
    ...
    /**
     * Método de test que prueba el recurso de listar resumen de ventas sin detalle.
     *
