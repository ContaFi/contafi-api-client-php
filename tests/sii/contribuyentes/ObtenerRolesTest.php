...
/**
 * Clase de pruebas para listar los roles existentes de un contribuyente.
 */
class ObtenerRolesTest extends TestCase
{
    /**
    ...
    /**
     * Método de test que prueba el recurso de obtener un listado de roles
     * registrados en el contribuyente.
     *
     * @throws \contafi\api_client\ApiException si la
     * búsqueda falla, o si ocurre un error de conexión.
     * @return void
     */
    public function testObtenerRoles()
    {
        try {
            ...
            if (self::$verbose) {
                echo "\n",'testObtenerRoles() Roles: ',$response->getBody()->getContents(),"\n";
            }
