...
/**
 * Clase de pruebas para obtener las estadísticas de un contribuyente.
 */
class ObtenerEstadisticasContribuyenteTest extends TestCase
{
    /**
    ...
    /**
     * Método de test que prueba el recurso de obtener las estadísticas de un
     * contribuyente a partir de su RUT.
     *
     * @throws \contafi\api_client\ApiException si el contribuyente no existe,
