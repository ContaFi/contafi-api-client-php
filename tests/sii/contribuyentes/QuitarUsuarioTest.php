...
/**
 * Clase de pruebas para quitar un usuario con cierto rol en un contribuyente.
 */
class QuitarUsuarioTest extends TestCase
{
    use FunctionHelpers;
    /**
    ...
    /**
     * Método de test que prueba el recurso de quitar autorización a un usuario
     * con cierto rol en un contribuyente.
     *
     * @throws \contafi\api_client\ApiException si el usuario o rol no existen,
