...
.. code-block:: shell
    CONTAFI_API_URL="https://contafi.cl"
    CONTAFI_API_TOKEN="token-contafi"
    CONTAFI_CONTRIBUYENTE_RUT="12345678-9"
...
.. code-block:: shell
    ./vendor/bin/phpunit --filter testObtenerDatosContribuyente --no-coverage
